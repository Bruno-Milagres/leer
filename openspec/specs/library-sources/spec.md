...
Abstração de fontes de biblioteca do app Leer: interface comum `LibrarySource`, implementações (Calibre, pasta local) e agregação multi-fonte via `LibraryRepository`.
